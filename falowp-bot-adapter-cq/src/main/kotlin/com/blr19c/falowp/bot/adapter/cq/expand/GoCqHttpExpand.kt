 ...
 * @return 消息id
 */
suspend fun BotApi.sendPrivateMsg(
    groupId: String? = null,
 ...
 * @return 消息id
 */
suspend fun BotApi.sendGroupMsg(
 ...
 */
suspend fun BotApi.sendGroupForwardMsg(
    groupId: String = this.receiveMessage.source.id,
    messages: Any
): String {
    return apiRequest<Map<String, String>>(
 ...
 * @param messages 自定义转发消息
 */
suspend fun BotApi.sendPrivateForwardMsg(
    userId: String = this.receiveMessage.sender.id,
    messages: Any
): String {
    return apiRequest<Map<String, String>>(
 ...
 * 撤回消息
 */
suspend fun BotApi.deleteMsg(messageId: String = this.receiveMessage.id) {
 ...
 * 获取消息
 */
suspend fun BotApi.getMsg(messageId: String = this.receiveMessage.id): GoCQHttpMessage {
 ...
 * @return 文件绝对路径
 */
suspend fun BotApi.downloadFile(
    url: String,
    threadCount: Int = 3,
 ...
 */
suspend fun BotApi.checkUrlSafely(url: String): Int {
 ...
 */
suspend fun BotApi.getForwardMsg(messageId: String = this.receiveMessage.id): List<GoCQHttpMessage> {
 ...
 */
suspend fun BotApi.getGroupMsgHistory(
    groupId: String = this.receiveMessage.source.id,
    messageSeq: Long,
 ...
 * @param groupId 群组id
 */
suspend fun BotApi.getEssenceMsgList(groupId: String = this.receiveMessage.source.id): List<EssenceMsg> {
 ...
 * @param groupId 群组id
 */
suspend fun BotApi.getGroupAtAllRemain(groupId: String = this.receiveMessage.source.id): GroupAtAllRemain {
 ...
 * @param messageId 消息id
 */
suspend fun BotApi.markMsgAsRead(messageId: String = this.receiveMessage.id) {
 ...
 * @param enabled 启用管理员
 */
suspend fun BotApi.setGroupAdmin(
    groupId: String = this.receiveMessage.source.id,
    userId: String = this.receiveMessage.sender.id,
 ...
 * @param groupName 群名称
 */
suspend fun BotApi.setGroupName(
    groupId: String = this.receiveMessage.source.id,
    groupName: String
) {
    apiRequest<Unit>(
 ...
 * @param cache 是否使用缓存
 */
suspend fun BotApi.setGroupPortrait(
    groupId: String = this.receiveMessage.source.id,
    file: String,
    cache: Boolean = true
) {
 ...
 * @param messageId 消息id
 */
suspend fun BotApi.setEssenceMsg(messageId: String = this.receiveMessage.id) {
 ...
 * @param messageId 消息id
 */
suspend fun BotApi.deleteEssenceMsg(messageId: String = this.receiveMessage.id) {
 ...
 * @param groupId 群组id
 */
suspend fun BotApi.sendGroupSign(groupId: String = this.receiveMessage.source.id) {
 ...
 * @param image 图片路径
 */
suspend fun BotApi.sendGroupNotice(
    groupId: String = this.receiveMessage.source.id,
    content: String,
    image: String? = null
) {
 ...
 * @param groupId 群组id
 */
suspend fun BotApi.getGroupNotice(groupId: String = this.receiveMessage.source.id): GroupNotice {
 ...
 */
suspend fun BotApi.uploadGroupFile(
    groupId: String = this.receiveMessage.source.id,
    file: String,
    name: String,
 ...
 * 删除群文件
 */
suspend fun BotApi.deleteGroupFile(groupFile: GroupFile) {
    apiRequest<Unit>(
        "delete_group_file",
        mapOf(
 ...
 * @param name 文件夹名称
 */
suspend fun BotApi.createGroupFileFolder(
    groupId: String = this.receiveMessage.source.id,
    name: String
) {
    apiRequest<Unit>(
 ...
 */
suspend fun BotApi.deleteGroupFolder(groupFolder: GroupFolder) {
    apiRequest<Unit>(
        "delete_group_folder",
        mapOf(
 ...
 * @param groupId 群组id
 */
suspend fun BotApi.getGroupFileSystemInfo(groupId: String = this.receiveMessage.source.id): GroupFileSystemInfo {
 ...
 * @param groupId 群组id
 */
suspend fun BotApi.getGroupRootFiles(groupId: String = this.receiveMessage.source.id): GroupFileInfo {
 ...
 */
suspend fun BotApi.getGroupFilesByFolder(groupFolder: GroupFolder): GroupFileInfo {
    return apiRequest(
 ...
 */
suspend fun BotApi.getGroupFileUrl(groupFile: GroupFile): String {
    return apiRequest<Map<String, String>>(
        "get_group_file_url",
        mapOf(
            "group_id" to groupFile.groupId,
 ...
 */
suspend fun BotApi.setGroupLeave(
    groupId: String = this.receiveMessage.source.id,
 ...
 */
suspend fun BotApi.setGroupSpecialTitle(
    groupId: String = this.receiveMessage.source.id,
    userId: String = this.receiveMessage.sender.id,
    specialTitle: String = "",
) {
 ...
 * @param fileName 文件名称
 */
suspend fun BotApi.uploadPrivateFile(
    userId: String = this.receiveMessage.sender.id,
    file: String,
    fileName: String
) {
 ...
 */
suspend fun BotApi.setFriendAddRequest(event: RequestAddFriendEvent, approve: Boolean, reason: String = "") {
    apiRequest<Unit>(
 ...
 * @param userId 用户id
 */
suspend fun BotApi.deleteFriend(userId: String = this.receiveMessage.sender.id) {
 ...
 * @param image 图片id
 */
suspend fun BotApi.ocrImage(image: String): OcrImage {
 ...
 * 获取登录号信息
 */
suspend fun BotApi.getLoginInfo(): LoginInfo {
 ...
 * @param userId 用户id
 */
suspend fun BotApi.getStrangerInfo(userId: String = this.receiveMessage.sender.id): StrangerInfo {
    return apiRequest(
        "get_stranger_info",
 ...
 * 获取好友列表
 */
suspend fun BotApi.getFriendList(): List<FriendInfo> {
 ...
 * @param cache 缓存
 */
suspend fun BotApi.getGroupInfo(
    groupId: String = this.receiveMessage.source.id,
    cache: Boolean = true
): GroupInfo {
    return apiRequest(
 ...
 * @param cache 缓存
 */
suspend fun BotApi.getGroupList(cache: Boolean = true): List<GroupInfo> {
 ...
 * @param cache 缓存
 */
suspend fun BotApi.getGroupMemberInfo(
    groupId: String = this.receiveMessage.source.id,
    userId: String = this.receiveMessage.sender.id,
    cache: Boolean = true
): GroupMemberInfo {
 ...
 * @param cache 缓存
 */
suspend fun BotApi.getGroupMemberList(
    groupId: String = this.receiveMessage.source.id,
    cache: Boolean = true
 ...
 */
suspend fun BotApi.getGroupHonorInfo(
    groupId: String = this.receiveMessage.source.id,
    type: String = "all"
): GroupHonorInfo {
    return apiRequest(
 ...
 * @return 转换后的语音文件路径
 */
suspend fun BotApi.getRecord(file: String, outFormat: String = "mp3"): String {
    return apiRequest<Map<String, String>>(
        "get_record",
 ...
 * @param file 文件缓存名
 */
suspend fun BotApi.getImage(file: String): Image? {
 ...
 * @param userId 用户id
 */
fun BotApi.avatar(userId: String = this.receiveMessage.sender.id): ImageUrl {
 ...
 * 检查是否可以发送图片
 */
suspend fun BotApi.canSendImage(): Boolean {
 ...
 * 检查是否可以发送语音
 */
suspend fun BotApi.canSendRecord(): Boolean {
 ...
 * 获取运行状态
 */
suspend fun BotApi.getStatus(): Status {
 ...
 * 获取版本信息
 */
suspend fun BotApi.getVersionInfo(): VersionInfo {
 ...
 */
suspend fun BotApi.setQQProfile(
    nickname: String,
    company: String,
    email: String,
    college: String,
 ...
 * 获取当前账号在线客户端列表
 */
suspend fun BotApi.getOnlineClients(cache: Boolean = true): OnlineClients {
    return apiRequest(
        "get_online_clients",
...
private suspend inline fun <reified T : Any> apiRequest(url: String, body: Any = emptyMap<String, String>()): T? {
    ...
    val typeReference = object : TypeReference<GoCqApiResult<T>>() {}
